...
growth_hacking = Product.create(title: "Growth Hacking", subtitle: "Crash Course", author: "Mattan Griffel", price:"4.99", 
	sku:"GROHACK1", length: "30 minutes", download_url: "https://s3.amazonaws.com/ahab-month-stripe-payments/dschool.stanford.edu_wp-content_uploads_2011_03_BootcampBootleg2010v2SLIM.pdf",
    details: "You'll get one video", author_image_name: "teacher-image.jpg", description:%{<p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", subtitle: "Ongoing Course", author: "Mattan Griffel", price:"4.99", 
    sku:"GROHACK2", length: "6 months", download_url: "https://s3.amazonaws.com/ahab-month-stripe-payments/dschool.stanford.edu_wp-content_uploads_2011_03_BootcampBootleg2010v2SLIM.pdf",
